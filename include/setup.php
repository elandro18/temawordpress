<?php
    ...
    function bs_theme_styles(){
        ...
        wp_enqueue_style("cleanblog", get_template_directory_uri().'/css/clean-blog.css');
        ...
        wp_enqueue_script("cleanblog_js",get_template_directory_uri().'/js/clean-blog.min.js', array('jquery'), '1.0', true);
